...
**1 - Arbitrary Write / Arbitrary Read:**
...
* **Arbitrary Write**: qua `fread()` viết vào memory
...
* **Arbitrary Read**: qua `fwrite()` leak từ memory
...
**2 - Classic FSOP — Vtable Hijacking (pre-glibc 2.24)**
